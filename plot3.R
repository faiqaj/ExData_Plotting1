...
submetering1 <- as.numeric(specificdata$Sub_metering_1)
submetering2 <- as.numeric(specificdata$Sub_metering_2)
submetering3 <- as.numeric(specificdata$Sub_metering_3)
